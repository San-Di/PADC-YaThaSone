...
/**
 * Created by UNiQUE on 10/1/2016.
 */
public class FavouriteJokeAdapter extends RecyclerView.Adapter<JokeViewHolder> {
    ...
    public FavouriteJokeAdapter(List<JokeVO> jokeVOs, JokeViewHolder.ControllerJokeItem mController) {
